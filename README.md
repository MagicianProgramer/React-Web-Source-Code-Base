# Our Restaurant - React ecommerce website
Our Restaurant is an ecommerce website built using React, Redux integrated with Node.js and Express backend.

The app is responsive (suitable for different screen sizes - phone, tablet, etc.)
![Our restaurant](website.gif "Our restaurant")
